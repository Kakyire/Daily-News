...
class EntertainmentScreen: UIViewController, UITableViewDelegate {
   ...
   @objc fileprivate func getNews() {
        networkRequest.getNews(for: K.entertainment, complete: { res in
...
extension EntertainmentScreen: UITableViewDataSource{
    ...
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        if contentOffsetY + screenHeight >= contentHeight {
            ...
            if !isLoading {
                ...
                networkRequest.getNews(for: K.entertainment, page: currentPage, complete: {res in
                    self.isLoading = true
